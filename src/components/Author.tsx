      ...
      <div className="relative mx-auto max-w-5xl pt-16 sm:px-6">
        <div className="bg-slate-50 pt-px sm:rounded-6xl">
          ...
          <div className="px-4 py-10 sm:px-10 sm:py-16 md:py-20 lg:px-20 lg:py-32">
            <SectionHeading number="5" id="author-title" className="">
              Founder
            </SectionHeading>
            <p className="mt-8 font-display text-5xl font-extrabold tracking-tight text-slate-900 sm:text-6xl">
              <span className="block text-blue-600">Peter Zheng –</span> Founder
              of Future Sphere Education Foundation.
            </p>
            <p className="mt-4 text-lg tracking-tight text-slate-700">
              I have been working in the education industry for over 10 years,
              and I have been a teacher, a school principal, and a school owner.
              I believe that quality education should not be a privilege for the
              fortunate few, but a right for all.
            </p>
            <p className="mt-8">
              <Link
                href="#"
