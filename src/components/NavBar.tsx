...
const sections = [
  {
    ...
    title: (
      <>
        <span className="hidden lg:inline">Our Mission</span>
        <span className="lg:hidden">Our Mission</span>
      </>
    ),
  },
  { id: 'screencasts', title: 'How it works' },
  { id: 'resources', title: 'Roadmap' },
  { id: 'pricing', title: 'Donate Today' },
  { id: 'author', title: 'Team' },
]
...
export function NavBar() {
  ...
  useEffect(() => {
    function updateActiveIndex() {
      ...
      let offset =
        bodyRect.top +
        (navBarRef.current || { offsetHeight: 0 }).offsetHeight +
        1
